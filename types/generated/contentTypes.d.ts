...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    doc_type: Attribute.Enumeration<['CC', 'CE', 'PA']> & Attribute.Required;
    doc_num: Attribute.BigInteger & Attribute.Required & Attribute.Unique;
    ...
    role_public_name: Attribute.Enumeration<
      ['Administrador', 'Organizador', 'Voluntario']
    > &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<
      ['Programado', 'En Progreso', 'Finalizado', 'Cancelado']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'Programado'>;
...
export interface ApiOrganizationOrganization extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    nit: Attribute.BigInteger & Attribute.Required & Attribute.Unique;
    address: Attribute.String & Attribute.Required;
    contact_number: Attribute.BigInteger &
      Attribute.Required &
      Attribute.Unique;
    website: Attribute.Text;
    state: Attribute.Boolean & Attribute.Required;
